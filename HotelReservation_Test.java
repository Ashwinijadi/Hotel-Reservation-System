...
public class HotelReservation_Test {
	...
	public void addHotelNameInReservationSystemTest() {
		...
		boolean nameCheck = HotelReservation.addHotel("LakeWood", 110,90);
		boolean nameCheck1 = HotelReservation.addHotel("BridgeWood", 160,50);
		boolean nameCheck2 = HotelReservation.addHotel("RidgeWood", 220,150);
